...
export class Camera {
  ...
  constructor(wcCenter: vec2, wcWidth: number, viewportArray: vec4) {
  ...
  setViewport(viewportArray: vec4) { this.mViewport = viewportArray; }
  getViewport() { return this.mViewport; }

  setBackgroundColor(newColor: vec4) { this.mBGColor = newColor; }
